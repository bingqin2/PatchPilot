...
export interface ExternalExposureCloseoutArchive {
  id: string;
  status: DemoReadinessStatus;
  closeoutReady: boolean;
  summary: string;
...
export interface DemoLiveTriggerLaunchPackage {
  status: DemoReadinessStatus;
  readyToPost: boolean;
  repository: string;
  issueNumber: number;
  ...
  nextActions: string[];
  sideEffectContract: string;
  liveLaunchGate: DemoLiveLaunchGate;
  generatedAt: string;
  markdownReport: string;
}
...
export interface DemoLiveDemoHandoffDeliveryFinalizationArchive {
  id: string;
  status: DemoReadinessStatus;
  finalized: boolean;
  summary: string;
  ...
  downloadActions: string[];
  sideEffectContract: string;
  finalizationGeneratedAt: string;
  archivedAt: string;
  report: string;
}
