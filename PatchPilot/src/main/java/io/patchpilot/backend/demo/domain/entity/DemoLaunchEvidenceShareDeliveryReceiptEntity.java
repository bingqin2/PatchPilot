...
@Data
@TableName("demo_launch_evidence_share_delivery_receipt")
public class DemoLaunchEvidenceShareDeliveryReceiptEntity {
    ...
    @TableField("launch_evidence_archive_id")
    private String launchEvidenceArchiveId;
