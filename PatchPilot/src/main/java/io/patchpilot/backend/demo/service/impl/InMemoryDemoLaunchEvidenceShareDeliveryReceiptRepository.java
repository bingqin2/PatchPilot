...
@Repository
@Profile("default")
public class InMemoryDemoLaunchEvidenceShareDeliveryReceiptRepository
        implements DemoLaunchEvidenceShareDeliveryReceiptRepository {

    private static final int MAX_RECEIPTS = 20;

    private final List<DemoLaunchEvidenceShareDeliveryReceiptVo> receipts = new CopyOnWriteArrayList<>();
