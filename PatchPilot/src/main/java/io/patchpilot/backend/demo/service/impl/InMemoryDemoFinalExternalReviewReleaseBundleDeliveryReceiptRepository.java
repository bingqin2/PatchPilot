...
@Repository
@Profile("default")
public class InMemoryDemoFinalExternalReviewReleaseBundleDeliveryReceiptRepository
        implements DemoFinalExternalReviewReleaseBundleDeliveryReceiptRepository {

    private static final int MAX_RECEIPTS = 20;

    private final List<DemoFinalExternalReviewReleaseBundleDeliveryReceiptVo> receipts =
