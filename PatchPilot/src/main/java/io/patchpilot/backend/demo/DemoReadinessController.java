...
public class DemoReadinessController {
    ...
    private final DemoFinalExternalReviewEvidencePackageDeliveryFinalizationService
    ...
    private final DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveService
            demoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveService;
    private final DemoFinalExternalReviewReleaseBundleDeliveryCertificateService
    ...
    @GetMapping("/final-acceptance-completion-closeout")
    public ApiResponse<DemoFinalAcceptanceCompletionCloseoutVo> getFinalAcceptanceCompletionCloseout() {
    ...
    @GetMapping("/final-external-review-evidence-package/delivery-finalization")
    public ApiResponse<DemoFinalExternalReviewEvidencePackageDeliveryFinalizationVo>
    getFinalExternalReviewPackageDeliveryFinalization() {
        return ApiResponse.ok(demoFinalExternalReviewEvidencePackageDeliveryFinalizationService.getFinalizationGate());
    }

    @PostMapping("/final-external-review-evidence-package/delivery-finalization/archives")
    public ResponseEntity<ApiResponse<DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveVo>>
    archiveFinalExternalReviewPackageDeliveryFinalization() {
        try {
            DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveVo archive =
                    demoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveService
                            .archiveCurrentFinalization();
            operatorSafetyAuditService.recordSafetyAudit(new RecordOperatorSafetyAuditCommand(
                    "DEMO_FINAL_EXTERNAL_REVIEW_PACKAGE_DELIVERY_FINALIZATION_ARCHIVED",
                    "DEMO_FINAL_EXTERNAL_REVIEW_PACKAGE_DELIVERY_FINALIZATION_ARCHIVE",
                    archive.id(),
                    TriggerQuarantineScope.REPOSITORY,
                    "patchpilot/local-demo",
                    "admin-api",
                    "Archived final external-review package delivery finalization "
                            + archive.status()
                            + " with receipt "
    ...
    @GetMapping("/final-external-review-evidence-package/delivery-finalization/archives")
    public ApiResponse<List<DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveVo>>
    listFinalExternalReviewPackageDeliveryFinalizationArchives() {
        return ApiResponse.ok(
                demoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveService.listRecentArchives()
        );
    }
    ...
    @PostMapping("/final-external-review-delivery-certificate/archives")
    public ResponseEntity<ApiResponse<DemoFinalExternalReviewDeliveryCertificateArchiveVo>>
    archiveFinalExternalReviewDeliveryCertificate() {
        try {
            DemoFinalExternalReviewDeliveryCertificateArchiveVo archive =
                    demoFinalExternalReviewDeliveryCertificateArchiveService.archiveCurrentCertificate();
            operatorSafetyAuditService.recordSafetyAudit(new RecordOperatorSafetyAuditCommand(
                    "DEMO_FINAL_EXTERNAL_REVIEW_DELIVERY_CERTIFICATE_ARCHIVED",
                    "DEMO_FINAL_EXTERNAL_REVIEW_DELIVERY_CERTIFICATE_ARCHIVE",
                    archive.id(),
                    TriggerQuarantineScope.REPOSITORY,
                    "patchpilot/local-demo",
                    "admin-api",
                    "Archived final external-review delivery certificate "
                            + archive.status()
                            + " with receipt "
                            + archive.latestDeliveryReceiptId()
            ));
    ...
    @GetMapping("/final-external-review-delivery-certificate/archives")
    public ApiResponse<List<DemoFinalExternalReviewDeliveryCertificateArchiveVo>>
    listFinalExternalReviewDeliveryCertificateArchives() {
    ...
    @PostMapping("/final-external-review-release-bundle/delivery-finalization/archives")
    public ResponseEntity<ApiResponse<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo>>
    archiveFinalExternalReviewReleaseBundleDeliveryFinalization() {
        try {
            ...
            operatorSafetyAuditService.recordSafetyAudit(new RecordOperatorSafetyAuditCommand(
                    ...
                    "patchpilot/local-demo",
                    "admin-api",
                    "Archived final external-review release bundle delivery finalization "
                            + archive.status()
                            + " with receipt "
                            + archive.latestDeliveryReceiptId()
            ));
    ...
    @GetMapping("/final-external-review-release-bundle/delivery-finalization/archives")
    public ApiResponse<List<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo>>
    listFinalExternalReviewReleaseBundleDeliveryFinalizationArchives() {
        return ApiResponse.ok(
                demoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveService.listRecentArchives()
        );
    }

    @GetMapping("/final-external-review-release-bundle/delivery-certificate")
    public ApiResponse<DemoFinalExternalReviewReleaseBundleDeliveryCertificateVo>
    getFinalExternalReviewReleaseBundleDeliveryCertificate() {
        return ApiResponse.ok(demoFinalExternalReviewReleaseBundleDeliveryCertificateService.getCertificate());
    }

    @PostMapping("/final-external-review-release-bundle/delivery-certificate/archives")
    public ResponseEntity<ApiResponse<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>>
    archiveFinalExternalReviewReleaseBundleDeliveryCertificate() {
        try {
            DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo archive =
                    demoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveService
                            .archiveCurrentCertificate();
            operatorSafetyAuditService.recordSafetyAudit(new RecordOperatorSafetyAuditCommand(
                    "DEMO_FINAL_EXTERNAL_REVIEW_RELEASE_BUNDLE_DELIVERY_CERTIFICATE_ARCHIVED",
                    "DEMO_FINAL_EXTERNAL_REVIEW_RELEASE_BUNDLE_DELIVERY_CERTIFICATE_ARCHIVE",
                    archive.id(),
                    TriggerQuarantineScope.REPOSITORY,
                    "patchpilot/local-demo",
                    "admin-api",
                    "Archived final external-review release bundle delivery certificate "
                            + archive.status()
                            + " with receipt "
                            + archive.latestDeliveryReceiptId()
            ));
    ...
    @GetMapping("/final-external-review-release-bundle/delivery-certificate/archives")
    public ApiResponse<List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>>
    listFinalExternalReviewReleaseBundleDeliveryCertificateArchives() {
        return ApiResponse.ok(
                demoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveService.listRecentArchives()
        );
    }
    ...
    @GetMapping(value = "/final-acceptance-completion-closeout/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadFinalAcceptanceCompletionCloseoutReport() {
        return markdownAttachment(
    ...
    @GetMapping(value = "/final-external-review-evidence-package/delivery-finalization/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadFinalExternalReviewPackageDeliveryFinalizationReport() {
        return markdownAttachment(
                "patchpilot-final-external-review-package-delivery-finalization.md",
                demoFinalExternalReviewEvidencePackageDeliveryFinalizationService
                        .getFinalizationGate()
                        .markdownReport()
        );
    ...
    @GetMapping(value = "/final-external-review-evidence-package/delivery-finalization/archives/{archiveId}/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadArchivedFinalExternalReviewPackageDeliveryFinalizationReport(
            @PathVariable String archiveId
    ) {
        return demoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveService.findArchive(archiveId)
                .map(archive -> markdownAttachment(
    ...
    @GetMapping(value = "/final-external-review-delivery-certificate/archives/{archiveId}/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadArchivedFinalExternalReviewDeliveryCertificateReport(
            @PathVariable String archiveId
    ) {
        return demoFinalExternalReviewDeliveryCertificateArchiveService.findArchive(archiveId)
                .map(archive -> markdownAttachment(
    ...
    @GetMapping(value = "/final-external-review-release-bundle/delivery-finalization/archives/{archiveId}/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadArchivedFinalExternalReviewReleaseBundleDeliveryFinalizationReport(
            @PathVariable String archiveId
    ) {
        return demoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveService.findArchive(archiveId)
                .map(archive -> markdownAttachment(
    ...
    @GetMapping(value = "/final-external-review-release-bundle/delivery-certificate/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadFinalExternalReviewReleaseBundleDeliveryCertificateReport() {
        return markdownAttachment(
                "patchpilot-final-external-review-release-bundle-delivery-certificate.md",
                demoFinalExternalReviewReleaseBundleDeliveryCertificateService.getCertificate().markdownReport()
        );
    }

    @GetMapping(value = "/final-external-review-release-bundle/delivery-certificate/archives/{archiveId}/report/download", produces = "text/markdown;charset=UTF-8")
    public ResponseEntity<String> downloadArchivedFinalExternalReviewReleaseBundleDeliveryCertificateReport(
            @PathVariable String archiveId
    ) {
        return demoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveService.findArchive(archiveId)
                .map(archive -> markdownAttachment(
