...
@Repository
@Profile("default")
public class InMemoryDemoHandoffShareDeliveryReceiptRepository implements DemoHandoffShareDeliveryReceiptRepository {

    private static final int MAX_RECEIPTS = 20;

    private final List<DemoHandoffShareDeliveryReceiptVo> receipts = new CopyOnWriteArrayList<>();
