...
import io.patchpilot.backend.demo.domain.DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceVo;
...
import io.patchpilot.backend.demo.domain.DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceVo;
...
import io.patchpilot.backend.security.exposure.ExternalExposureCloseoutArchiveService;
...
public class DemoEvidenceBundleService {
    ...
    private final Supplier<DemoFinalExternalReviewReleaseBundleVo> finalExternalReviewReleaseBundleSupplier;
    private final Supplier<List<DemoFinalExternalReviewReleaseBundleArchiveVo>>
            finalExternalReviewReleaseBundleArchiveSupplier;
    private final Supplier<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo>
            finalExternalReviewReleaseBundleDeliveryFinalizationSupplier;
    private final Supplier<List<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo>>
            finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier;
    private final Supplier<List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>>
            finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier;
    private final Supplier<List<ExternalExposureCloseoutArchiveVo>> externalExposureCloseoutArchiveSupplier;
    private Supplier<DemoFinalReviewerHandoffDeliveryFinalizationVo>
            finalReviewerHandoffDeliveryFinalizationSupplier =
            DemoEvidenceBundleService::compatibilityFinalReviewerHandoffDeliveryFinalization;
    ...
    public DemoEvidenceBundleService(
            ...
            DemoFinalExternalReviewReleaseBundleService demoFinalExternalReviewReleaseBundleService,
            DemoFinalExternalReviewReleaseBundleArchiveRepository finalExternalReviewReleaseBundleArchiveRepository,
            DemoFinalExternalReviewReleaseBundleDeliveryFinalizationService
                    demoFinalExternalReviewReleaseBundleDeliveryFinalizationService,
            DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveRepository
                    finalExternalReviewReleaseBundleDeliveryFinalizationArchiveRepository,
            DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveRepository
                    finalExternalReviewReleaseBundleDeliveryCertificateArchiveRepository,
            DemoFinalReviewerHandoffDeliveryFinalizationService demoFinalReviewerHandoffDeliveryFinalizationService,
            ExternalExposureCloseoutArchiveService externalExposureCloseoutArchiveService,
        ...
        this(
                ...
                demoFinalExternalReviewReleaseBundleService::getReleaseBundle,
                () -> finalExternalReviewReleaseBundleArchiveRepository.listRecentArchives(20),
                demoFinalExternalReviewReleaseBundleDeliveryFinalizationService::getFinalizationGate,
                () -> finalExternalReviewReleaseBundleDeliveryFinalizationArchiveRepository.listRecentArchives(20),
                () -> finalExternalReviewReleaseBundleDeliveryCertificateArchiveRepository.listRecentArchives(20),
                externalExposureCloseoutArchiveService::listRecentArchives
        );
        this.finalReviewerHandoffDeliveryFinalizationSupplier =
                demoFinalReviewerHandoffDeliveryFinalizationService::getFinalizationGate;
    }
    ...
    DemoEvidenceBundleService(
            ...
            Supplier<List<DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveVo>>
                    finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier,
            Supplier<DemoFinalExternalReviewReleaseBundleVo> finalExternalReviewReleaseBundleSupplier
    ) {
        this(
                readinessSupplier,
                ...
                finalExternalReviewEvidencePackageDeliveryFinalizationSupplier,
                finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier,
                finalExternalReviewReleaseBundleSupplier,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundleArchives,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundleDeliveryFinalization
        );
    }
    ...
    DemoEvidenceBundleService(
            ...
            Supplier<List<DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveVo>>
                    finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier,
            Supplier<DemoFinalExternalReviewReleaseBundleVo> finalExternalReviewReleaseBundleSupplier,
            Supplier<List<DemoFinalExternalReviewReleaseBundleArchiveVo>>
                    finalExternalReviewReleaseBundleArchiveSupplier
    ) {
        this(
                readinessSupplier,
    ...
    DemoEvidenceBundleService(
            ...
            Supplier<List<DemoFinalExternalReviewReleaseBundleArchiveVo>>
                    finalExternalReviewReleaseBundleArchiveSupplier,
            Supplier<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo>
                    finalExternalReviewReleaseBundleDeliveryFinalizationSupplier
    ) {
        this(
                readinessSupplier,
                ...
                finalExternalReviewReleaseBundleArchiveSupplier,
                finalExternalReviewReleaseBundleDeliveryFinalizationSupplier,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundleDeliveryFinalizationArchives,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundleDeliveryCertificateArchives
        );
    }
    ...
    DemoEvidenceBundleService(
            ...
            Supplier<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo>
                    finalExternalReviewReleaseBundleDeliveryFinalizationSupplier,
            Supplier<List<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo>>
                    finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier,
            Supplier<List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>>
                    finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier
    ) {
        this(
                readinessSupplier,
                ...
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier,
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier,
                DemoEvidenceBundleService::compatibilityExternalExposureCloseoutArchives
        );
    }
    ...
    DemoEvidenceBundleService(
            ...
            Supplier<List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>>
                    finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier,
            Supplier<List<ExternalExposureCloseoutArchiveVo>> externalExposureCloseoutArchiveSupplier
    ) {
        ...
        this.finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier =
                finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier;
        this.finalExternalReviewReleaseBundleSupplier = finalExternalReviewReleaseBundleSupplier;
        this.finalExternalReviewReleaseBundleArchiveSupplier = finalExternalReviewReleaseBundleArchiveSupplier;
        this.finalExternalReviewReleaseBundleDeliveryFinalizationSupplier =
                finalExternalReviewReleaseBundleDeliveryFinalizationSupplier;
        this.finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier =
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier;
        this.finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier =
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier;
        this.externalExposureCloseoutArchiveSupplier = externalExposureCloseoutArchiveSupplier;
    }
    ...
    DemoEvidenceBundleService(
        ...
        this(
                ...
                finalExternalReviewEvidencePackageDeliveryFinalizationSupplier,
                finalExternalReviewEvidencePackageDeliveryFinalizationArchiveSupplier,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundle,
                DemoEvidenceBundleService::compatibilityFinalExternalReviewReleaseBundleArchives
        );
    }
    ...
    public DemoEvidenceBundleVo getEvidenceBundle() {
        ...
        DemoFinalExternalReviewReleaseBundleVo finalExternalReviewReleaseBundle =
                finalExternalReviewReleaseBundleSupplier.get();
        DemoFinalExternalReviewReleaseBundleArchiveEvidenceVo finalExternalReviewReleaseBundleArchiveEvidence =
                finalExternalReviewReleaseBundleArchiveEvidence(
                        finalExternalReviewReleaseBundleArchiveSupplier.get()
                );
        DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo
                finalExternalReviewReleaseBundleDeliveryFinalization =
                finalExternalReviewReleaseBundleDeliveryFinalizationSupplier.get();
        DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceVo
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence =
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence(
                        finalExternalReviewReleaseBundleDeliveryFinalizationArchiveSupplier.get()
                );
        List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>
                finalExternalReviewReleaseBundleDeliveryCertificateArchives =
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveSupplier.get();
        DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceVo
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence =
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence(
                        finalExternalReviewReleaseBundleDeliveryCertificateArchives
                );
        DemoFinalReviewerHandoffPackageVo finalReviewerHandoffPackage =
                finalReviewerHandoffPackageEvidence(finalExternalReviewReleaseBundleDeliveryCertificateArchives);
        DemoFinalReviewerHandoffDeliveryFinalizationVo finalReviewerHandoffDeliveryFinalization =
                finalReviewerHandoffDeliveryFinalizationSupplier.get();
        DemoExternalExposureCloseoutArchiveEvidenceVo externalExposureCloseoutArchiveEvidence =
                externalExposureCloseoutArchiveEvidence(externalExposureCloseoutArchiveSupplier.get());
    ...
    private static DemoExternalExposureCloseoutArchiveEvidenceVo externalExposureCloseoutArchiveEvidence(
            List<ExternalExposureCloseoutArchiveVo> archives
    ) {
        ExternalExposureCloseoutArchiveVo latestArchive = archives.isEmpty() ? null : archives.get(0);
        if (latestArchive == null) {
            return new DemoExternalExposureCloseoutArchiveEvidenceVo(
                    DemoReadinessStatus.NEEDS_ATTENTION,
                    false,
                    false,
                    "No external exposure closeout archive is available.",
                    ...
                    "MISSING",
                    null,
                    List.of("No archived external exposure closeout evidence is available in the top-level bundle."),
                    List.of("Archive the external exposure closeout before using the evidence bundle as public URL shutdown proof."),
                    "GET /api/demo/evidence-bundle is read-only and does not mutate tasks, Git, GitHub, or public exposure."
            );
        }

        DemoReadinessStatus status = externalExposureCloseoutArchiveEvidenceStatus(latestArchive);
        String nextAction = status == DemoReadinessStatus.READY
                ? "Use the archived external exposure closeout as public URL shutdown proof."
                : "Close the temporary public URL session, refresh readiness evidence, then archive a new external exposure closeout.";
        List<String> downloadActions = new ArrayList<>();
        downloadActions.add("Download external exposure closeout archive " + latestArchive.id() + ".");
        if (hasText(latestArchive.linkedReadinessArchiveId())) {
            downloadActions.add("Download linked external exposure readiness archive "
                    + latestArchive.linkedReadinessArchiveId() + ".");
        }

        return new DemoExternalExposureCloseoutArchiveEvidenceVo(
                status,
                true,
                latestArchive.closeoutReady(),
                externalExposureCloseoutArchiveEvidenceSummary(latestArchive, status),
                nextAction,
                archives.size(),
                latestArchive.id(),
                latestArchive.latestSessionId(),
                latestArchive.latestSessionStatus(),
                latestArchive.publicUrl(),
                latestArchive.webhookUrl(),
                latestArchive.linkedReadinessArchiveId(),
                latestArchive.handoffStatus(),
                latestArchive.archiveFreshness(),
                latestArchive.archivedAt(),
                latestArchive.evidenceNotes(),
                List.copyOf(downloadActions),
                latestArchive.sideEffectContract()
        );
    }

    private static DemoReadinessStatus externalExposureCloseoutArchiveEvidenceStatus(
            ExternalExposureCloseoutArchiveVo archive
    ) {
        if ("BLOCKED".equals(archive.status())) {
            return DemoReadinessStatus.BLOCKED;
        }
        return "READY".equals(archive.status()) && archive.closeoutReady()
                ? DemoReadinessStatus.READY
                : DemoReadinessStatus.NEEDS_ATTENTION;
    }

    private static String externalExposureCloseoutArchiveEvidenceSummary(
            ExternalExposureCloseoutArchiveVo archive,
            DemoReadinessStatus status
    ) {
        if (status == DemoReadinessStatus.READY) {
            return "Latest external exposure closeout archive proves the temporary public URL session is closed.";
        }
        if ("BLOCKED".equals(archive.status())) {
            return "Latest external exposure closeout archive is blocked.";
        }
        return "Latest external exposure closeout archive is not closeout-ready yet.";
    }

    private static List<ExternalExposureCloseoutArchiveVo> compatibilityExternalExposureCloseoutArchives() {
        return List.of(new ExternalExposureCloseoutArchiveVo(
                "external-exposure-closeout-archive-compat",
                "READY",
                true,
                "External exposure closeout archive proves the temporary public URL session is closed.",
                "Use this archived closeout as public URL shutdown proof.",
                "external-exposure-session-compat",
                "CLOSED",
                "https://example.trycloudflare.com",
                "https://example.trycloudflare.com/api/github/webhook",
                "Compatibility demo exposure",
                "PatchPilot",
                Instant.EPOCH,
                "PatchPilot",
                Instant.EPOCH,
                "Compatibility closeout.",
                "external-exposure-readiness-archive-compat",
                "READY",
                "CURRENT",
                4,
                0,
                ...
                4,
                List.of(),
                List.of("Compatibility external exposure closeout archive is READY and closed."),
                List.of("Download external exposure closeout archive external-exposure-closeout-archive-compat."),
                "Compatibility external exposure closeout archive is read-only.",
                Instant.EPOCH,
                Instant.EPOCH,
                "# PatchPilot External Exposure Closeout Archive"
        ));
    }
    ...
    finalExternalReviewReleaseBundleArchiveEvidence(
            List<DemoFinalExternalReviewReleaseBundleArchiveVo> archives
    ) {
        DemoFinalExternalReviewReleaseBundleArchiveVo latestArchive = archives.isEmpty() ? null : archives.get(0);
        if (latestArchive == null) {
            return new DemoFinalExternalReviewReleaseBundleArchiveEvidenceVo(
                    ...
                    null,
                    null,
                    List.of("Archive the READY final external-review release bundle.")
            );
        }

        DemoReadinessStatus status = finalExternalReviewReleaseBundleArchiveEvidenceStatus(latestArchive);
        String nextAction = status == DemoReadinessStatus.READY
                ? "Use the archived final external-review release bundle as the external-review handoff record."
                : "Resolve final external-review release bundle archive blockers, then archive a new ready bundle.";
        List<String> downloadActions = new ArrayList<>();
        downloadActions.add("Download final external-review release bundle archive " + latestArchive.id() + ".");
        if (hasText(latestArchive.latestCertificateArchiveId())) {
            downloadActions.add("Download final external-review delivery certificate archive "
                    + latestArchive.latestCertificateArchiveId() + ".");
        }
        if (hasText(latestArchive.latestDeliveryFinalizationArchiveId())) {
            downloadActions.add("Download final external-review package delivery finalization archive "
                    + latestArchive.latestDeliveryFinalizationArchiveId() + ".");
        }

        return new DemoFinalExternalReviewReleaseBundleArchiveEvidenceVo(
                status,
                true,
                latestArchive.releaseReady(),
                finalExternalReviewReleaseBundleArchiveEvidenceSummary(latestArchive, status),
                nextAction,
                archives.size(),
                latestArchive.id(),
                latestArchive.latestCertificateArchiveId(),
                latestArchive.latestDeliveryFinalizationArchiveId(),
                latestArchive.latestPackageArchiveId(),
                latestArchive.latestDeliveryReceiptId(),
                latestArchive.latestTaskId(),
                latestArchive.latestPullRequestUrl(),
                latestArchive.archivedAt(),
    ...
    private static DemoReadinessStatus finalExternalReviewReleaseBundleArchiveEvidenceStatus(
            DemoFinalExternalReviewReleaseBundleArchiveVo archive
    ) {
        if (archive.status() == DemoReadinessStatus.BLOCKED) {
            return DemoReadinessStatus.BLOCKED;
        }
        return archive.status() == DemoReadinessStatus.READY && archive.releaseReady()
                ? DemoReadinessStatus.READY
                : DemoReadinessStatus.NEEDS_ATTENTION;
    }

    private static String finalExternalReviewReleaseBundleArchiveEvidenceSummary(
            DemoFinalExternalReviewReleaseBundleArchiveVo archive,
            DemoReadinessStatus status
    ) {
        if (status == DemoReadinessStatus.READY) {
            return "Latest final external-review release bundle archive is ready.";
        }
        if (archive.status() == DemoReadinessStatus.BLOCKED) {
            return "Latest final external-review release bundle archive is blocked.";
        }
        return "Latest final external-review release bundle archive is not ready yet.";
    }

    private static DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceVo
    finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence(
            List<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo> archives
    ) {
        DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo latestArchive =
                archives.isEmpty() ? null : archives.get(0);
        if (latestArchive == null) {
            return new DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceVo(
                    DemoReadinessStatus.NEEDS_ATTENTION,
                    false,
                    false,
                    ...
                    null,
                    null,
                    List.of("Archive the READY final external-review release bundle delivery finalization.")
            );
        }

        DemoReadinessStatus status =
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceStatus(latestArchive);
        String nextAction = status == DemoReadinessStatus.READY
                ? "Use the archived final external-review release bundle delivery finalization as the terminal reviewer handoff proof."
                : "Resolve final external-review release bundle delivery finalization archive blockers, then archive a new finalized record.";
        List<String> downloadActions = new ArrayList<>();
        downloadActions.add(
                "Download final external-review release bundle delivery finalization archive "
                        + latestArchive.id() + "."
        );
        if (hasText(latestArchive.latestArchiveId())) {
            downloadActions.add("Download final external-review release bundle archive "
                    + latestArchive.latestArchiveId() + ".");
        }
        if (hasText(latestArchive.latestDeliveryReceiptId())) {
            downloadActions.add("Download final external-review release bundle delivery receipt "
                    + latestArchive.latestDeliveryReceiptId() + ".");
        }
        if (hasText(latestArchive.latestCertificateArchiveId())) {
            downloadActions.add("Download final external-review delivery certificate archive "
        ...
        return new DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceVo(
                ...
                true,
                latestArchive.finalized(),
                finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceSummary(latestArchive, status),
                nextAction,
                archives.size(),
                latestArchive.id(),
                latestArchive.latestArchiveId(),
    ...
    private static DemoReadinessStatus finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceStatus(
    ...
    private static String finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidenceSummary(
            DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo archive,
            DemoReadinessStatus status
    ) {
        if (status == DemoReadinessStatus.READY) {
            return "Latest final external-review release bundle delivery finalization archive is finalized and ready.";
        }
        if (archive.status() == DemoReadinessStatus.BLOCKED) {
            return "Latest final external-review release bundle delivery finalization archive is blocked.";
        }
        return "Latest final external-review release bundle delivery finalization archive is not finalized yet.";
    }

    private static DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceVo
    finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence(
            List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo> archives
    ) {
        DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo latestArchive =
                archives.isEmpty() ? null : archives.get(0);
        if (latestArchive == null) {
            return new DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceVo(
                    DemoReadinessStatus.NEEDS_ATTENTION,
                    false,
                    false,
                    "No final external-review release bundle delivery certificate archive is available.",
                    ...
                    null,
                    null,
                    List.of("Archive the certified final external-review release bundle delivery certificate.")
            );
        }

        DemoReadinessStatus status =
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceStatus(latestArchive);
        String nextAction = status == DemoReadinessStatus.READY
                ? "Use the archived final external-review release bundle delivery certificate as the terminal reviewer handoff proof."
                : "Resolve final external-review release bundle delivery certificate archive blockers, then archive a certified certificate.";
        List<String> downloadActions = new ArrayList<>();
        downloadActions.add(
                "Download final external-review release bundle delivery certificate archive "
                        + latestArchive.id() + "."
        );
        if (hasText(latestArchive.latestDeliveryFinalizationArchiveId())) {
            downloadActions.add("Download final external-review release bundle delivery finalization archive "
                    + latestArchive.latestDeliveryFinalizationArchiveId() + ".");
        }
        if (hasText(latestArchive.latestReleaseBundleArchiveId())) {
            downloadActions.add("Download final external-review release bundle archive "
                    + latestArchive.latestReleaseBundleArchiveId() + ".");
        }
        if (hasText(latestArchive.latestDeliveryReceiptId())) {
            downloadActions.add("Download final external-review release bundle delivery receipt "
                    + latestArchive.latestDeliveryReceiptId() + ".");
        ...
        return new DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceVo(
                status,
                true,
                latestArchive.certified(),
                finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceSummary(latestArchive, status),
                nextAction,
                archives.size(),
                latestArchive.id(),
                latestArchive.latestDeliveryFinalizationArchiveId(),
    ...
    private static DemoReadinessStatus finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceStatus(
    ...
    private static String finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidenceSummary(
            DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo archive,
            DemoReadinessStatus status
    ) {
        if (status == DemoReadinessStatus.READY) {
            return "Latest final external-review release bundle delivery certificate archive is certified and ready.";
        }
        if (archive.status() == DemoReadinessStatus.BLOCKED) {
            return "Latest final external-review release bundle delivery certificate archive is blocked.";
        }
        return "Latest final external-review release bundle delivery certificate archive is not certified yet.";
    }

    private static DemoFinalReviewerHandoffPackageVo finalReviewerHandoffPackageEvidence(
            List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo> archives
    ) {
        DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo latestArchive =
                archives.isEmpty() ? null : archives.get(0);
        if (latestArchive == null) {
            return new DemoFinalReviewerHandoffPackageVo(
                    ...
                    List.of("Final reviewer handoff package is unavailable until terminal proof is archived."),
                    List.of("Archive the certified terminal release-bundle delivery certificate before downloading the final reviewer handoff package."),
        ...
        boolean readyForReview = latestArchive.status() == DemoReadinessStatus.READY
                && latestArchive.certified()
                && latestArchive.releaseBundleDeliveryReceiptFresh()
                && hasText(latestArchive.latestReleaseBundleArchiveId());
        DemoReadinessStatus status = finalReviewerHandoffPackageStatus(latestArchive, readyForReview);
        String nextAction = status == DemoReadinessStatus.READY
                ? "Send the handoff package report and listed attachments to the external reviewer."
                : "Resolve final reviewer handoff package blockers, then download the package report.";
        List<String> attachments = new ArrayList<>();
        List<String> downloads = new ArrayList<>();
        downloads.add("Download final reviewer handoff package report.");
        downloads.add("Download final external-review release bundle delivery certificate archive "
                + latestArchive.id() + ".");
        if (readyForReview) {
            attachments.add("Final reviewer handoff package report.");
            attachments.add("Terminal release-bundle delivery certificate archive " + latestArchive.id() + ".");
        }
        if (hasText(latestArchive.latestReleaseBundleArchiveId())) {
            if (readyForReview) {
                attachments.add("Frozen release bundle archive " + latestArchive.latestReleaseBundleArchiveId() + ".");
            }
            downloads.add("Download final external-review release bundle archive "
                    + latestArchive.latestReleaseBundleArchiveId() + ".");
        }
        if (hasText(latestArchive.latestDeliveryFinalizationArchiveId())) {
            if (readyForReview) {
            ...
            downloads.add("Download final external-review release bundle delivery finalization archive "
                    + latestArchive.latestDeliveryFinalizationArchiveId() + ".");
        }
        if (hasText(latestArchive.latestDeliveryReceiptId())) {
            if (readyForReview) {
                attachments.add("Release-bundle delivery receipt " + latestArchive.latestDeliveryReceiptId() + ".");
            }
            downloads.add("Download final external-review release bundle delivery receipt "
                    + latestArchive.latestDeliveryReceiptId() + ".");
        }
        if (hasText(latestArchive.latestPullRequestUrl())) {
            downloads.add("Open Pull Request " + latestArchive.latestPullRequestUrl() + " for external review.");
        }

        return new DemoFinalReviewerHandoffPackageVo(
                status,
                readyForReview,
                finalReviewerHandoffPackageSummary(latestArchive, readyForReview, status),
                nextAction,
                latestArchive.id(),
                latestArchive.latestDeliveryFinalizationArchiveId(),
                latestArchive.latestReleaseBundleArchiveId(),
                ...
                latestArchive.latestCertificateArchiveId(),
                latestArchive.latestPackageArchiveId(),
                latestArchive.latestPackageDeliveryReceiptId(),
                latestArchive.latestTaskId(),
                latestArchive.latestPullRequestUrl(),
                latestArchive.latestDeliveryTarget(),
                latestArchive.latestDeliveryChannel(),
                latestArchive.latestDeliveredAt(),
                latestArchive.archivedAt(),
                List.copyOf(attachments),
                List.of(new DemoFinalReviewerHandoffPackageVo.Check(
                        "Terminal delivery certificate archive",
                        latestArchive.certified() ? DemoReadinessStatus.READY : status,
                        latestArchive.certified()
                                ? "Latest terminal certificate archive is certified."
                                : "Latest terminal certificate archive is not certified.",
                        latestArchive.certified() ? "No action needed." : "Archive a certified terminal certificate."
                )),
                List.of("Terminal certificate archive " + latestArchive.id()
                        + (latestArchive.certified() ? " is certified." : " is not certified.")),
                List.copyOf(downloads),
                "GET /api/demo/evidence-bundle is read-only and does not mutate tasks, Git, or GitHub.",
                "# PatchPilot Final Reviewer Handoff Package\n",
                Instant.now()
        );
    ...
    private static DemoReadinessStatus finalReviewerHandoffPackageStatus(
            DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo archive,
    ...
    private static String finalReviewerHandoffPackageSummary(
            DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo archive,
            boolean readyForReview,
            DemoReadinessStatus status
    ) {
    ...
    private static DemoFinalExternalReviewReleaseBundleVo compatibilityFinalExternalReviewReleaseBundle() {
        return new DemoFinalExternalReviewReleaseBundleVo(
                ...
                "Compatibility final external-review release bundle is read-only.",
                "# PatchPilot Final External Review Release Bundle"
        );
    }

    private static List<DemoFinalExternalReviewReleaseBundleArchiveVo>
    compatibilityFinalExternalReviewReleaseBundleArchives() {
        DemoFinalExternalReviewReleaseBundleVo bundle = compatibilityFinalExternalReviewReleaseBundle();
        return List.of(new DemoFinalExternalReviewReleaseBundleArchiveVo(
    ...
    compatibilityFinalExternalReviewReleaseBundleDeliveryFinalization() {
        return new DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo(
                ...
                List.of(new DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo.Check(
                        ...
                        DemoReadinessStatus.READY,
                        "Compatibility final external-review release bundle delivery receipt is fresh.",
                        "No action needed."
                )),
                List.of("Compatibility final external-review release bundle delivery is finalized."),
                List.of("Download final external-review release bundle delivery finalization report."),
                "Compatibility final external-review release bundle delivery finalization is read-only.",
                "# PatchPilot Final External Review Release Bundle Delivery Finalization",
                Instant.EPOCH
        );
    }

    private static List<DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo>
    compatibilityFinalExternalReviewReleaseBundleDeliveryFinalizationArchives() {
        DemoFinalExternalReviewReleaseBundleDeliveryFinalizationVo finalization =
                compatibilityFinalExternalReviewReleaseBundleDeliveryFinalization();
        return List.of(new DemoFinalExternalReviewReleaseBundleDeliveryFinalizationArchiveVo(
                "final-external-review-release-bundle-delivery-finalization-archive-compat",
                finalization.status(),
                finalization.finalized(),
                "Final external-review release bundle delivery finalization archive is ready.",
                "Use the archived release bundle delivery finalization as terminal reviewer handoff proof.",
                ...
                List.of("Download final external-review release bundle delivery finalization archive."),
                "Compatibility final external-review release bundle delivery finalization archive is read-only.",
    ...
    private static List<DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo>
    compatibilityFinalExternalReviewReleaseBundleDeliveryCertificateArchives() {
        return List.of(new DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo(
                "final-external-review-release-bundle-delivery-certificate-archive-compat",
                DemoReadinessStatus.READY,
                true,
                "Final external-review release bundle delivery certificate archive is certified.",
                "Use the archived release bundle delivery certificate as terminal reviewer handoff proof.",
                "final-external-review-release-bundle-delivery-finalization-archive-compat",
                "final-external-review-release-bundle-archive-compat",
                "final-external-review-release-bundle-delivery-receipt-compat",
                "final-external-review-delivery-certificate-archive-compat",
                ...
                List.of(new DemoFinalExternalReviewReleaseBundleDeliveryCertificateArchiveVo.Check(
                        "Final external-review release bundle delivery certificate archive",
                        DemoReadinessStatus.READY,
                        "Compatibility final external-review release bundle delivery certificate archive is certified.",
                        "No action needed."
                )),
                List.of("Compatibility final external-review release bundle delivery certificate archive is certified."),
                List.of("Download final external-review release bundle delivery certificate archive."),
                "Compatibility final external-review release bundle delivery certificate archive is read-only.",
                "# PatchPilot Final External Review Release Bundle Delivery Certificate Archive",
                Instant.EPOCH,
                Instant.EPOCH
        ));
    }

    private static DemoFinalReviewerHandoffDeliveryFinalizationVo
    compatibilityFinalReviewerHandoffDeliveryFinalization() {
        return new DemoFinalReviewerHandoffDeliveryFinalizationVo(
                ...
                List.of(new DemoFinalReviewerHandoffDeliveryFinalizationVo.Check(
                        ...
                        DemoReadinessStatus.READY,
                        "Compatibility final reviewer handoff delivery receipt is fresh.",
                        "No action needed."
                )),
                List.of("Compatibility final reviewer handoff delivery is finalized."),
    ...
    private static DemoReadinessStatus aggregateStatus(
        ...
        if (readiness.status() == DemoReadinessStatus.BLOCKED
                ...
                || finalExternalReviewReleaseBundle.status() == DemoReadinessStatus.BLOCKED
                || finalExternalReviewReleaseBundleArchiveEvidence.status() == DemoReadinessStatus.BLOCKED
                || finalExternalReviewReleaseBundleDeliveryFinalization.status() == DemoReadinessStatus.BLOCKED
                || finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence.status()
                == DemoReadinessStatus.BLOCKED
                || finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence.status()
                == DemoReadinessStatus.BLOCKED
                || finalReviewerHandoffPackage.status()
                == DemoReadinessStatus.BLOCKED
                || finalReviewerHandoffDeliveryFinalization.status()
                == DemoReadinessStatus.BLOCKED
                || externalExposureCloseoutArchiveEvidence.status()
                == DemoReadinessStatus.BLOCKED) {
            return DemoReadinessStatus.BLOCKED;
        }
        if (readiness.status() == DemoReadinessStatus.NEEDS_ATTENTION
                ...
                || finalExternalReviewEvidencePackageDeliveryFinalizationArchiveEvidence.status()
                == DemoReadinessStatus.NEEDS_ATTENTION
                || finalExternalReviewReleaseBundle.status() == DemoReadinessStatus.NEEDS_ATTENTION
                || finalExternalReviewReleaseBundleArchiveEvidence.status() == DemoReadinessStatus.NEEDS_ATTENTION
                || finalExternalReviewReleaseBundleDeliveryFinalization.status()
                == DemoReadinessStatus.NEEDS_ATTENTION
                || finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence.status()
                == DemoReadinessStatus.NEEDS_ATTENTION
                || finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence.status()
    ...
    private static List<String> nextActions(
        ...
        if (finalExternalReviewReleaseBundle.status() != DemoReadinessStatus.READY) {
            actions.add(finalExternalReviewReleaseBundle.nextAction());
        }
        if (finalExternalReviewReleaseBundleArchiveEvidence.status() != DemoReadinessStatus.READY) {
            actions.add(finalExternalReviewReleaseBundleArchiveEvidence.nextAction());
        }
        if (finalExternalReviewReleaseBundleDeliveryFinalization.status() != DemoReadinessStatus.READY) {
            actions.add(finalExternalReviewReleaseBundleDeliveryFinalization.nextAction());
        }
        if (finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence.status()
                != DemoReadinessStatus.READY) {
            actions.add(finalExternalReviewReleaseBundleDeliveryFinalizationArchiveEvidence.nextAction());
        }
        if (finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence.status() != DemoReadinessStatus.READY) {
            actions.add(finalExternalReviewReleaseBundleDeliveryCertificateArchiveEvidence.nextAction());
        }
        if (finalReviewerHandoffPackage.status() != DemoReadinessStatus.READY) {
            actions.add(finalReviewerHandoffPackage.nextAction());
        }
        if (finalReviewerHandoffDeliveryFinalization.status() != DemoReadinessStatus.READY) {
            actions.add(finalReviewerHandoffDeliveryFinalization.nextAction());
        }
        if (externalExposureCloseoutArchiveEvidence.status() != DemoReadinessStatus.READY) {
            actions.add(externalExposureCloseoutArchiveEvidence.nextAction());
        }
