...
@Repository
@Profile("default")
public class InMemoryDemoReadinessSnapshotArchiveRepository implements DemoReadinessSnapshotArchiveRepository {

    private static final int MAX_ARCHIVES = 20;

    private final List<DemoReadinessSnapshotArchiveVo> archives = new CopyOnWriteArrayList<>();
