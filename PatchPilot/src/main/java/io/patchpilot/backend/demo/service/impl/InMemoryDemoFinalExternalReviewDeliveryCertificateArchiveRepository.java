...
@Repository
@Profile("default")
public class InMemoryDemoFinalExternalReviewDeliveryCertificateArchiveRepository
        implements DemoFinalExternalReviewDeliveryCertificateArchiveRepository {

    private static final int MAX_ARCHIVES = 20;

    private final List<DemoFinalExternalReviewDeliveryCertificateArchiveVo> archives =
