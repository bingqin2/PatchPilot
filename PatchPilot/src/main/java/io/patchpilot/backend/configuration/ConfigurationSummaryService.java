...
public class ConfigurationSummaryService {
    ...
    public ConfigurationSummaryVo getConfigurationSummary() {
        ...
        return new ConfigurationSummaryVo(
                ...
                safetyProperties.isRejectedTriggerQuarantineEnabled(),
                safetyProperties.getRejectedTriggerQuarantineWindowMs(),
                safetyProperties.getRejectedTriggerQuarantineThreshold(),
                safetyProperties.getRejectedTriggerQuarantineCooldownMs(),
