CREATE TABLE IF NOT EXISTS demo_final_external_review_release_bundle_archive (
    ...
    latest_certificate_archived_at TIMESTAMP(6),
    required_attachments_json JSON NOT NULL,
    release_checks_json JSON NOT NULL,
    ...
    INDEX idx_final_external_review_release_bundle_archive_archived_at (archived_at),
    INDEX idx_final_external_review_release_bundle_archive_status (status),
    INDEX idx_final_external_review_release_bundle_archive_ready (release_ready)
);
