CREATE TABLE IF NOT EXISTS demo_final_external_review_delivery_certificate_archive (
    ...
    INDEX idx_final_external_review_delivery_certificate_archive_archived_at (archived_at),
    INDEX idx_final_external_review_delivery_certificate_archive_status (status),
    INDEX idx_final_external_review_delivery_certificate_archive_certified (certified)
);
