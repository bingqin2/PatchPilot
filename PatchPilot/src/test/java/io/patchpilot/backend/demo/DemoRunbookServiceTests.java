...
class DemoRunbookServiceTests {
    ...
    void should_format_demo_evidence_bundle_as_markdown_runbook() {
        ...
        assertThat(runbook)
                ...
                .contains("- Final external-review package delivery finalization: `READY` - Final external-review package delivery is finalized with a fresh package delivery receipt.")
                .contains("- Final external-review package delivery finalized: `true`")
                .contains("- Final external-review finalized package archive: `final-external-review-package-archive-1`")
                .contains("- Final external-review finalized delivery receipt: `final-external-review-package-delivery-receipt-1`")
                ...
                .contains("- Final external-review release bundle delivery certificate archive: `READY` - Latest final external-review release bundle delivery certificate archive is certified and ready.")
                .contains("- Final external-review release bundle delivery certificate archive id: `final-external-review-release-bundle-delivery-certificate-archive-1`")
                .contains("- Final external-review release bundle delivery certificate archived finalization: `final-external-review-release-bundle-delivery-finalization-archive-1`")
                .contains("- Final external-review release bundle delivery certificate archived release bundle: `final-external-review-release-bundle-archive-1`")
                .contains("- Final external-review release bundle delivery certificate archived receipt: `final-external-review-release-bundle-delivery-receipt-1`")
                .contains("- Final external-review release bundle delivery certificate archive next action: Use the archived final external-review release bundle delivery certificate as terminal reviewer handoff proof.")
                .contains("- Final external-review release bundle delivery certificate archive download: Download final external-review release bundle delivery certificate archive final-external-review-release-bundle-delivery-certificate-archive-1.")
                .contains("- Final reviewer handoff delivery finalization: `READY` - Final reviewer handoff delivery is finalized with compatibility evidence.")
                .contains("- Final reviewer handoff delivery finalized: `true`")
                .contains("- Final reviewer handoff delivery receipt: `final-reviewer-handoff-delivery-receipt-compat`")
                .contains("- Final reviewer handoff delivery terminal certificate: `final-external-review-release-bundle-delivery-certificate-archive-compat`")
                .contains("- Final reviewer handoff delivery release bundle: `final-external-review-release-bundle-archive-compat`")
                .contains("- Final reviewer handoff delivery target: reviewer@example.com via email")
                .contains("- Final reviewer handoff delivery receipt freshness: `FRESH`")
                .contains("- Final reviewer handoff delivery next action: Use the final reviewer handoff delivery finalization report as the terminal demo closeout record.")
                .contains("- Final reviewer handoff delivery finalization download: Download final reviewer handoff delivery finalization report.")
                .contains("## Readiness")
