...
class DemoFinalExternalReviewEvidencePackageDeliveryFinalizationArchiveMigrationTests {

    @Test
    void creates_final_external_review_package_delivery_finalization_archive_table() throws Exception {
        String migration = Files.readString(Path.of(
                "src/main/resources/db/migration/V56__create_demo_final_external_review_evidence_package_delivery_finalization_archive.sql"
        ));

        assertThat(migration)
                .contains("CREATE TABLE IF NOT EXISTS demo_final_external_review_evidence_package_delivery_finalization_archive");
        ...
        assertThat(migration).contains("latest_closeout_archive_id VARCHAR(64)");
        ...
        assertThat(migration).contains("idx_final_external_review_delivery_finalization_archive_archived_at");
        assertThat(migration).contains("idx_final_external_review_delivery_finalization_archive_status");
    }
}
