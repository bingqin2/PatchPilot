...
- The first implementation surface is a read-only evaluation case catalog API and dashboard panel, so operators can inspect supported language and safety-rejection scenarios before automated benchmark execution exists.
