...
- Format a handoff package as copyable or downloadable Markdown that wraps the session report with concise status, task, Pull Request, prepared-command, archived-outcome, and next-action evidence for post-demo sharing.
