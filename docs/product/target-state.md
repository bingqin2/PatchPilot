...
The first stable adapters are Java/Maven, Java/Gradle, Node/npm, and Python/pytest. Follow-up adapters should prioritize common interview- and demo-friendly stacks:

- Node.js with pnpm or yarn.
