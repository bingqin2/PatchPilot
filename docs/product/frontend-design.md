...
- Demo readiness summarizes credentials, safety policy state, adapter fixture verification, queue health, worker heartbeat readiness, and recent Pull Request evidence before an operator starts a live smoke run.
