...
- Repository preflight visibility lets an operator enter a local path such as `docs/demo-repositories/java-maven`, run the real adapter registry, and see whether that repository shape would be supported before creating a task.
