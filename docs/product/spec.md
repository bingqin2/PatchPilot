...
- An operator can archive the certified final external-review release bundle delivery certificate as the durable terminal proof, reopen recent release-bundle certificate archives, and download the exact Markdown certificate after live inputs change.
