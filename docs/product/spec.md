...
- Operators should be able to inspect and download a final launch evidence finalization gate that treats the launch evidence package as accepted only when the latest archived launch evidence package is share-ready and the latest delivery receipt is fresh for the current archive/session.
...
- An operator can use one final launch evidence finalization gate to prove the current launch package is share-ready, has a fresh delivery receipt, and can be accepted as complete final launch evidence.
