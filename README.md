...
- Pre-execution safety snapshots in task detail, copied Markdown reports, and the dashboard, including trigger source, final allow decision, safety, quarantine, rate-limit, issue-context, and model classification evidence.
