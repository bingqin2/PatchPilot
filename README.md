...
The evidence bundle endpoint is the one-call demo summary. It includes readiness, smoke checklist, non-sensitive configuration, adapter fixture counts, full evaluation run readiness, queue summary, recent task and Pull Request evidence, combined webhook setup readiness, latest webhook delivery, a capped recent webhook delivery trail with task/rejected-trigger/error outcomes, rejected-trigger counts, active quarantine count, latest handoff share checklist status, final handoff share center status, share-center download actions, latest handoff share delivery receipt summary and freshness state, final handoff finalization status, final launch evidence share-center status, final launch evidence finalization status, latest launch acceptance closeout and certificate archive status, latest task evidence acceptance certificate archive status, generated time, and next actions. The overall evidence-bundle status is not `READY` until the full evaluation archive evidence, handoff finalization gate, launch evidence finalization gate, accepted launch acceptance closeout archive evidence, certified launch acceptance certificate archive evidence, and certified task evidence acceptance certificate archive evidence are `READY`.
