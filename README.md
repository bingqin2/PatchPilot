...
- Demo final external-review release bundle that turns the latest certified certificate archive into one read-only reviewer handoff bundle with required attachments, checks, evidence notes, and a downloadable Markdown report.
