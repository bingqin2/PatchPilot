...
- Demo launch acceptance closeout that combines launch readiness, launch evidence package, share-center delivery proof, and finalization status into one final accepted/not-accepted operator report.
- Demo launch acceptance closeout archives that preserve the current final closeout as local evidence, list recent closeouts, and download archived Markdown reports after refresh or backend restart in database-backed local profiles.
- Demo launch acceptance certificate that turns the latest accepted READY closeout archive into one final certified/not-certified readout and downloadable Markdown certificate without mutating GitHub or creating tasks.
- Demo launch acceptance certificate archives that preserve the current certified readout as durable local evidence, list recent certificates, and download archived Markdown certificate reports after the live read model changes.
