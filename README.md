...
The rejected-trigger panel shows recent `/agent fix` comments that were intentionally refused before task creation, including the command text and rejection reason. Use it when GitHub shows a successful delivery but no task appears.
