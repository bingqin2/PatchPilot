...
- Demo final external-review release bundle delivery certificate archives that preserve the certified terminal release-bundle delivery certificate as durable local evidence, list recent frozen certificates, and download archived Markdown reports after live certificate inputs change.
