...
Use `/detail` for dashboard-style task inspection. It returns the task audit summary, timeline events, test runs, tool calls, and model calls in one response. The narrower endpoints remain available for focused debugging.
